	...
	UploadFile.prototype = {
		...
		initUploader: function() {
			...
			uploader.on('uploadBeforeSend', function(file, data, header) {
				...
				header['sign'] = md5('/datacenter/v1/fileupload/image' + Math.round(new Date().getTime() / 1000) + localStorage['userId' + sessionStorage['roleTypeId']] + sessionStorage['roleType'] + localStorage['randomAccessCode' + sessionStorage['roleTypeId']]);
			});
