	...
	<div class="income">
		...
		<el-card class="box-card">
            ...
            <div style="padding: 10px;">
                <el-button type="danger" size="small" @click="openConfirm(goodsIds, '是否将选中商品删除?', delGoodsByIds)" v-has="'del-sell-out'" :disabled="!goodsIds">批量删除</el-button>
            </div>
            <el-table :data="goodsData" @selection-change="handleSelectionChange" style="width: 100%">
                ...
                <el-table-column prop="status" label="状态" min-width="70">
                    <template slot-scope="scope">
                        <el-tag size="mini" type="info">已售馨</el-tag>
                    </template>
                </el-table-column>
				...
				<el-table-column label="操作" min-width="90" fixed="right">
                    <template slot-scope="scope">
                        <el-tooltip class="item" effect="dark" content="编辑" v-has="'sell-out-detail'" placement="top">
                            <el-button
                            size="mini"
                            type="primary"
                        ...
                        <el-tooltip class="item" effect="dark" content="删除" v-has="'del-sell-out'" placement="top">
                            <el-button
                            size="mini"
                            type="danger"
                            icon="el-icon-delete"
...
export default {
	...
	methods: {
		...
		goDetail (id) {
			this.$router.push({ path: 'sell-out-detail', query: { gid: id }})
        },
