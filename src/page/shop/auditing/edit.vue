<template>
    <div class="shop-goods-detail">
        ...
        <el-tabs v-model="activeName" @tab-click="handleClick">
            <div class="shop-back" v-if="tips && info.checkStatus === 2">
                <div>
                    <i class="el-icon-warning"></i>
                    <span>该商品审核受理中，不可修改信息</span>
            ...
            <el-tab-pane label="商品规格" name="third" class="good-info">
                <el-card class="goods-card">
                    ...
                    <el-row class="goods-row">
                        <c-spec :gid="gid" :up-deta="spec" @getSkuData="getSkuData" :obtain="obtain"></c-spec>
                    </el-row>
                </el-card>
            </el-tab-pane>
        ...
        <div class="shop-footer">
            <el-button type="primary" size="small" class="footer-btn" @click="correcting" :disabled="info.checkStatus === 2">保存信息</el-button>
        </div>
        <el-dialog
            title="编辑"
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="editCheckGoodsInfo">确 定</el-button>
            </span>
        </el-dialog>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        getGoodsDetail (id) {
			...
			vm.$get(vm.$api.shop.getCheckGoodsInfoById, param).then(resp => {
                vm.info = resp
        ...
        editCheckGoodsInfo () {
            ...
            // vm.$nextTick(function () { // 等待 dom 节点完成改变
                ...
                vm.$post(vm.$api.shop.editCheckGoodsInfo, param).then(resp => {
                    // vm.getGoodsDetail(vm.gid)
                    vm.$message({
                        message: '保存成功',
                        type: 'success'
