    ...
    <div class="food-detail">
		            ...
		            <el-row>
		                <el-form label-width="140px" :model="ruleForm" :rules="rules" ref="ruleForm">
		                    ...
		                    <div class="flex-center">
		                        <el-button v-if="info.checkStatus === 0 || info.checkStatus === 2" type="warning" size="small" class="footer-btn" @click="showVisible('ruleForm')">提交审核</el-button>
		                    	<el-button v-else type="primary" size="small" class="footer-btn" @click="showVisible('ruleForm')"">保存信息</el-button>
		                    </div>
		                </el-form>
		            </el-row>
                </el-card>
        ...
        <el-dialog
		  ...
		  <span slot="footer" class="dialog-footer">
		    ...
		    <el-button type="primary" @click="editDishInfo ('ruleForm')">确 定</el-button>
		  </span>
		</el-dialog>
    </div>
</template>
    ...
    methods: {
        ...
        editDishInfo(){
        	...
        	if (serviceRateType == 0 ) {
	        	...
	        	vm.$post(vm.$api.restaurant.editDishInfo, param).then(resp => {
	//		                vm.info = resp
	                vm.$message({
	                    message: '保存成功',
	                    type: 'success'
