            ...
            <template v-if="enState">
              ...
              <!-- <el-col :span="8">
                <el-form-item label="距离 :">
                  <el-input v-model="distance" placeholder="请填写搜索距离（公里）"></el-input>
                </el-form-item>
              </el-col> -->
            </template>
					<el-col :span="8">
...
export default {
    ...
    getGoodsCategoryOne () {
      let vm = this
		...
		getOnlineGoodsList () {
			...
			vm.$get(vm.$api.money.getOnlineGoodsList, param).then(resp => {
				vm.items = resp.list
    ...
    getAreaArr (arr) {
      this.areaArr = arr
		...
		goDetail (id) {
			this.$router.push({ path: 'upper-details', query: { gid: id }})
		},
		openConfirm() {
