                ...
                <el-card class="goods-card">
                    ...
                    <el-form :model="base" :rules="baseRules" ref="baseForm" label-width="140px" style="max-width: 800px;">
                        ...
                        <el-form-item label="商家商品分类：" prop="allianceGoodsCateIds">
                            <c-buy-class v-model="base.allianceGoodsCateIds"></c-buy-class>
                        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    openBaseVisible() {
      ...
      vm.base = {
        ...
        cateIds: vm.info.cateInfo
          ...
          : [],
        allianceGoodsCateIds: vm.info.allianceGoodsCateInfo
          ? vm.info.cateInfo.map(obj => obj.cateId)
          : [],
    ...
    addGoodsInfo() {
      ...
      vm.$post(vm.$api.buy.addGoodsInfo, param).then(resp => {
        vm.$message({
          message: '保存成功',
          type: 'success'
        })
