<template>
    <div class="buy-code">
        ...
        <el-dialog title="自助购物链接" :visible.sync="linkVise" width="680px">
			<div>
...
export default {
    ...
    data () {
        return {
            buyCode: [],
            baseUrl: 'http://www.cgc999.com/webcate/#/meal?no=',
            linkVise: false,
            codeLink: ''
        }
    },
    created () {
        if (window.location.host !== 'www.cgc999.com'){
            this.baseUrl = 'https://' + window.location.host + '/web/cate/#/meal?no='
        }
        this.getPayCode()
    },
    methods: {
