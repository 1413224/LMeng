        ...
        <div class="w-box">
          <div class="nav-logo">
            <h1 @click="changePage(-1)">
              <router-link to="/purchase-home" title="XMall商城官网">XMall商城</router-link>
            </h1>
          </div>
          <div class="right-box">
            <div class="nav-list">
              ...
              <router-link to="/purchase-brand"><a @click="changePage(2)">全部商品</a></router-link>
            </div>
            <div class="nav-aside" ref="aside" :class="{fixed:st}">
              <div class="shop pr" @mouseover="cartShowState(true)" @mouseout="cartShowState(false)"
                   ref="positionMsg">
                <router-link to="/purchase-cart"></router-link>
                <span class="cart-num">
...
<script>
  ...
  export default{
    ...
    methods: {
      ...
      //   if (path === '/purchase-home') {
      //     this.changePage(-1)
      //   } else if (path === '/purchase-goods') {
      //     this.changePage(-2)
      //   } else {
      //     this.changePage(0)
      //   }
